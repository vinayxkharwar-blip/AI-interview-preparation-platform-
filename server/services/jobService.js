...
const MOCK_JOBS = [
  ...
  },
  {
    ...
    description: 'Build production AI web applications leveraging Gemini LLMs, Python, Vector DBs, and real-time WebRTC audio/video avatar streams.',
    skills: ['Python', 'Node.js', 'React', 'Gemini AI', 'Vector DB', 'LangChain', 'Docker', 'Kubernetes', 'WebRTC'],
